...
what_parcels =  '/users/evelina9/fMRI_PROJECTS/ROIS/SearchSpace_BioLoc_lSTS.nii' %specify the full path to the *img or *nii file that will constrain the search for top voxels

MySPM = '/users/evelina9/fMRI_PROJECTS/spm_ss_vE/'
