...
csv_dir = fullfile(pwd, '..', 'Left_MTfROIsrespEventsMP_20160107_RESULTS');
...
roi_names = {'LMT'}; %I don't know the names of all the Dyloc parcels!!

roi_pres_order = [1]'; % the order we want to display things in. DOESN"T NEED TO CONTAIN ALL THE ROIS THAT EXIST!

%NOTE: if there is only one ROI, various graphing abilities misbehave,
